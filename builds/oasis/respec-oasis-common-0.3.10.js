...
define(
    'oasis/conventions',["tmpl!oasis/templates/conventions.html"],
...
define('text!oasis/css/conformance.css',[],function () { return '.conformance {\n    background-color: #E9FFBE;\n }\n\n.conformance-label {\n    text-transform:     lowercase;\n    font-variant:       small-caps;\n    font-style:         normal;\n    color:              #00B900;\n }\n\n table.conformance-table {\n\tborder: 1px solid gray;\n\tborder-collapse: collapse;\n\tborder-spacing: 0px;\n\tpadding-left: 0.5em;\n\tpadding-right: 1em;\n\tpadding-top: 3px;\n\tpadding-bottom: 0px;\n\tvertical-align: top;\n}\n\ntable.conformance-table td {\n\tborder: 1px solid gray;\n\tborder-collapse: collapse;\n\tborder-spacing: 0px;\n\tpadding-left: 0.5em;\n\tpadding-right: 2em;\n\tpadding-top: 3px;\n\tpadding-bottom: 0px;\n\tvertical-align: top;\n}\n\ntable.conformance-table th {\n\tborder: 1px solid gray;\n\tborder-collapse: collapse;\n\tborder-spacing: 0px;\n\tpadding-left: 0.5em;\n\tpadding-right: 2em;\n\tpadding-top: 4px;\n\tpadding-bottom: 2px;\n\tvertical-align: middle;\n\ttext-align: left;\n\tfont-weight: bold;\n}\n';});


define('tmpl!oasis/templates/conformance-table.html', ['handlebars'], function (hb) { return Handlebars.compile('{{#unless conformanceIntro}}\n<p>\n  Implementations of this specification need to satisfy the following conformance clauses.\n</p>\n{{/unless}}\n<table id=\'conformance-table\' class=\'conformance-table\'>\n  <thead>\n    <tr><th>Clause Number</th><th>Strength</th><th>Requirement</th></tr>\n  </thead>\n  {{#each conformanceClauseList}}\n    <tr><td class=\'conformance-label\'><a href="#{{id}}">{{clause}}</a></td><td><em class="rfc2119">{{strength}}</em></td><td>{{{text}}}</td></tr>\n  {{/each}}\n</table>\n');});

// Module oasis/conformance
// Complete the conformance section by adding a table of conformance clauses, if wanted.

define(
	'oasis/conformance-table',[ "text!oasis/css/conformance.css" ,
	  "tmpl!oasis/templates/conformance-table.html" ],
	function(css, confoTmpl) {
	    return {
		run : function(conf, doc, cb, msg) {
		    msg.pub("start", "oasis/conformance-table");
		    ...
		    msg.pub("end", "oasis/conformance-table");
		    cb();
		}
	    };
	});
